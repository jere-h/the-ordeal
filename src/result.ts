...
export class ResultScreen {
  ...
  show(): void {
    ...
    // A settling "aftermath" band (a lone figure walking out) bookends the arc —
    // the same regardless of stance, so it never reads as a grade.
    card.appendChild(sceneArt('aftermath'));
